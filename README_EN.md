...
> 📖 **[Twinkle Eval Conversational Wiki Page (Generated by DeepWiki)](https://deepwiki.com/ai-twinkle/Eval)**
> Note: Content is AI-generated and accuracy is not guaranteed; for reference only.
...
evaluation:
  ...
  system_prompt:        # System prompt, only used in box evaluation method
    zh: |
      The user will provide a question with options A, B, C, D
