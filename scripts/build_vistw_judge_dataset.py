...
併上原始資料集的 ``ground_truth``，產生階段 2 的資料集——其 ``question``
欄位是填好的 judge 提示詞。
...
def main() -> None:
    ...
    ap.add_argument(
        "--dataset", required=True, help="原始 VisTW-Dialogue 資料集（含 ground_truth）"
    )
